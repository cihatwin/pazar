...
const DEFAULT_HIGHLIGHTS = [
  ...
  },
  {
    ...
    text: "Fethiye'nin kalbinde yer alan mağazamızda ürünlerimizi yakından inceleyebilir, uzman danışmanlarımızdan destek alabilirsiniz.",
  },
  {
    icon: "🎁",
...
export async function getAboutPage(): Promise<AboutPageDoc> {
  try {
    ...
    return {
      ...
      hero: {
        eyebrow: s(x.hero?.eyebrow) || "Altıncı Kuyumculuk",
        title: s(x.hero?.title) || "Fethiye'nin Güvenilir Kuyum Evi",
        description:
          s(x.hero?.description) ||
          "Yılların deneyimi, köklü gelenekleri ve modern tasarım anlayışıyla Fethiye'nin kalbinde yer alan Bizim 6'ncı Kuyumculuk; sertifikalı ürünleri, güvenli alışveriş deneyimi ve müşteri memnuniyeti odaklı hizmet anlayışıyla özel anlarınıza değer katıyor.",
      ...
      story: {
        ...
        text1:
          s(x.story?.text1) ||
          "Bizim 6'ncı Kuyumculuk, Fethiye'nin en köklü kuyumcularından biri olarak yıllardır hizmet vermektedir. Altın, gümüş ve pırlanta işçiliğinde uzmanlaşmış ekibimizle, her parçayı özenle seçiyor ve müşterilerimize en kaliteli ürünleri sunuyoruz.",
        text2:
          s(x.story?.text2) ||
          "Geleneksel ustalığı modern tasarımlarla buluşturan markamız, her bir mücevherin bir hikâye anlattığına inanır. Düğünlerden doğum günlerine, nişanlardan yıldönümlerine; hayatın en değerli anlarına eşlik ediyoruz.",
      },
      gallery: {
      ...
      beliefs: {
        ...
        items: arr(x.beliefs?.items).length
          ...
          : [
              ...
              "Şeffaf ve güncel altın kuru ile fiyatlandırma yapılır",
