...
const DEFAULTS: SeoSettings = {
  meta: {
    ...
    twitterHandle: "",
    themeColor: "#0b0b0b",
    defaultKeywords: "altın, kuyumculuk, bileklik, kolye, yüzük, küpe, takı",
    author: "6’ncı Kuyumculuk",
    publisher: "6’ncı Kuyumculuk",
    appName: "6’ncı Kuyumculuk",
    brandAliases: "Altıncı Kuyumculuk, Altıncılar, Altıncı, 6nci, 6nci.tr",
  },
  google: {
