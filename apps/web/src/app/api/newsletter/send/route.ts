            ...
            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
              ...
              <tr>
                <td align="center" style="padding:12px 32px 4px">
                  <span style="font-size:13px;font-weight:700;color:#d4af37;letter-spacing:3px;text-transform:uppercase;font-family:Arial,sans-serif">BİZİM 6'NCI KUYUMCULUK</span>
                </td>
              </tr>
              <!-- Subject -->
              <tr>
            ...
            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
              ...
              <tr>
                <td align="center" style="padding-bottom:8px">
                  <p style="margin:0;font-size:12px;color:#999;font-family:Arial,sans-serif;line-height:1.6">Bizim 6'ncı Kuyumculuk<br>Fethiye, Muğla &bull; Türkiye</p>
                </td>
              </tr>
              <!-- Unsubscribe -->
              <tr>
