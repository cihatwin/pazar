...
export const metadata: Metadata = {
  title: "KVKK Aydınlatma Metni | 6'ncı Kuyumculuk",
  description:
...
export default function KvkkPage() {
  return (
    <LegalPageTemplate
      ...
      description="Bu aydınlatma metni, 6698 sayılı Kişisel Verilerin Korunması Kanunu kapsamında, BİZİM 6 KUYUMCULUK İNŞAAT EMLAK SANAYİ TİCARET LİMİTED ŞİRKETİ tarafından veri sorumlusu sıfatıyla hazırlanmıştır."
      sections={[
        {
          title: "Veri Sorumlusu",
          body: "Kişisel verileriniz, Cumhuriyet, Belediye Cd. No:9, 48303 Fethiye/Muğla adresinde faaliyet gösteren BİZİM 6 KUYUMCULUK İNŞAAT EMLAK SANAYİ TİCARET LİMİTED ŞİRKETİ tarafından işlenmektedir.",
        },
        {
