...
const HIGHLIGHTS_TR = [
  ...
  { icon: "🏪", title: "Fiziksel Mağaza", text: "Fethiye'nin kalbinde yer alan mağazamızda ürünlerimizi yakından inceleyebilir, uzman danışmanlarımızdan destek alabilirsiniz." },
...
const HIGHLIGHTS_EN = [
  ...
  { icon: "🏪", title: "Physical Store", text: "You can examine our products up close in our store located in the heart of Fethiye and get support from our expert consultants." },
...
const BELIEFS_EN = [
  ...
  "Transparent pricing with live gold rate updates",
