...
export const metadata: Metadata = {
  title: "Gizlilik Politikası | PAZAR.",
  description:
    "PAZAR. gizlilik politikası. Müşteri ve satıcı verilerinin işlenmesi, saklanması ve korunmasına ilişkin bilgilendirme.",
};
...
export default function PrivacyPolicyPage() {
  return (
    <LegalPageTemplate
      ...
      description="Bu gizlilik politikası, BİZİM 6 KUYUMCULUK İNŞAAT EMLAK SANAYİ TİCARET LİMİTED ŞİRKETİ tarafından PAZAR. markasıyla sunulan çok satıcılı platform ve ilişkili hizmetlerde işlenen kişisel verilere ilişkin temel bilgilendirmeyi içerir."
      sections={[
        {
          title: "Toplanan Veriler",
          body: "Müşteriler için ad, iletişim, teslimat, sipariş ve tercih verileri; satıcılar için bunlara ek olarak işletme, vergi, mağaza, ürün ve operasyon bilgileri hizmetin sunulması için işlenebilir.",
        },
        {
          title: "Satıcılarla Veri Paylaşımı",
          body: "Siparişin yerine getirilebilmesi için gerekli müşteri, teslimat ve sipariş bilgileri yalnızca ilgili siparişin satıcısıyla, amaçla sınırlı olarak paylaşılabilir. Satıcılar bu verileri bağımsız veri sorumlusu sıfatıyla yürürlükteki mevzuata uygun korumakla yükümlüdür.",
        },
        {
