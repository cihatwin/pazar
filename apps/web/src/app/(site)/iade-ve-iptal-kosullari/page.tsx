...
export const metadata: Metadata = {
  title: "İade ve İptal Koşulları | 6'ncı Kuyumculuk",
  description:
...
export default function ReturnPolicyPage() {
  return (
    <LegalPageTemplate
      ...
      description="Bu metin, 6'ncı Kuyumculuk üzerinden verilen siparişlerde iptal, iade ve geri ödeme süreçlerine ilişkin genel esasları açıklamaktadır."
      sections={[
        {
