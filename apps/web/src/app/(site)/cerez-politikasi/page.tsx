...
export const metadata: Metadata = {
  title: "Çerez Politikası | PAZAR.",
  description:
    "PAZAR. çerez politikası. Çerezlerin kullanım amaçları, üçüncü taraf araçlar ve tercih yönetimi.",
};
...
export default function CookiePolicyPage() {
  return (
    <LegalPageTemplate
      ...
      description="Bu çerez politikası, BİZİM 6 KUYUMCULUK İNŞAAT EMLAK SANAYİ TİCARET LİMİTED ŞİRKETİ tarafından PAZAR. markasıyla sunulan platformda kullanılan çerezler ve benzeri teknolojilere ilişkin bilgilendirmeyi içerir."
      sections={[
        {
          title: "Çerez Nedir?",
