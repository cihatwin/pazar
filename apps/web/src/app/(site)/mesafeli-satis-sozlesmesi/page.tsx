...
export const metadata: Metadata = {
  title: "Mesafeli Satış Sözleşmesi | 6'ncı Kuyumculuk",
  description:
...
export default function DistanceSalesAgreementPage() {
  return (
    <LegalPageTemplate
      ...
      description="Bu sözleşme, 6'ncı Kuyumculuk dijital satış kanalları üzerinden verilen siparişlerde alıcı ile satıcı arasındaki satış ilişkisinin genel esaslarını belirler."
      sections={[
        {
          title: "Taraflar",
          body: "Satıcı: BİZİM 6 KUYUMCULUK İNŞAAT EMLAK SANAYİ TİCARET LİMİTED ŞİRKETİ. Alıcı: Platform üzerinden sipariş veren kullanıcıdır.",
        },
        {
          title: "Konu",
