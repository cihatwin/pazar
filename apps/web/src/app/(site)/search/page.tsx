...
export default function SearchPage() {
  if (CATALOG_RESET_MODE) {
    return (
      <CatalogEmpty
        title="Aranacak ürün henüz yok"
        text="Eski katalog kapatıldı. Yeni ürünler eklendiğinde arama özelliği otomatik olarak yeniden kullanılabilir olacak."
      />
    );
  }
