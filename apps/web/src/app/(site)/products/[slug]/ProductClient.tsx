...
const FALLBACK_IMG = "/public/favicon-32.png";
/* ---------- utils ---------- */
function s(v: any) {
...
export default function ProductClient({ slug }: { slug: string }) {
  ...
  const t = useMemo(() => {
    ...
    return {
      ...
      askText: en
        ? "Our jewelry consultants are here to help with sizing, delivery and product details."
  ...
  function getReviewSourceMeta(r: ReviewDoc) {
    ...
    return {
      label: r.sourceLabel || "6nci Kuyumculuk",
