...
const FALLBACK_IMG = "/favicon-32x32.png";
...
const itemCount = previewItems.reduce(
  ...
  const bank = useMemo(() => {
    ...
    return {
      ...
      company: safeStr(raw.companyName) || "6’ncı Kuyumculuk",
  ...
  {isSales ? (
    ...
    <>
      ...
      <p>
        ...
        İşbu Mesafeli Satış Sözleşmesi, BİZİM 6 KUYUMCULUK İNŞAAT EMLAK SANAYİ

        TİCARET LİMİTED ŞİRKETİ ile ALICI arasında, 6’ncı Kuyumculuk internet
      ...
      <p>
        ...
        SATICI bilgileri: BİZİM 6 KUYUMCULUK İNŞAAT EMLAK SANAYİ TİCARET LİMİTED
    ...
    <>
      ...
      <p>
        ...
        Bu Ön Bilgilendirme Formu, 6’ncı Kuyumculuk internet sitesi üzerinden
      ...
      <p>
        ...
        6’ncı Kuyumculuk’ta bazı ürünlerin fiyatı canlı altın/değerli maden kuru
