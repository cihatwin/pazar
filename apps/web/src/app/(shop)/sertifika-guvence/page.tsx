...
export default function SertifikaGuvencePage() {
  ...
  const t = loc === "en"
    ? {
        ...
        title: "Clear information builds stronger trust in jewelry shopping.",
        lead:
          "At 6’ncı Kuyumculuk, certification and product assurance are presented with a transparent and understandable approach. Product setting, craftsmanship, and confidence must be clear before purchase—not after.",
        meta1: "Transparent details",
        meta2: "Reliable information",
        meta3: "Confident purchase",
        card1Title: "Why does certification matter?",
        card1Text:
          "Jewelry is not just a visual purchase. Product value, gold setting, workmanship quality, and technical details directly affect trust. Proper certification helps the buyer understand exactly what is being purchased.",
    ...
    : {
        ...
        title: "Kuyum alışverişinde güçlü güven, net bilgiyle başlar.",
        lead:
          "6’ncı Kuyumculuk’ta sertifika ve ürün güvence yaklaşımı, müşteriye şeffaf ve anlaşılır bilgi sunmak için tasarlanır. Ürün ayarı, işçilik ve değer algısı satın almadan önce netleşmelidir; sonradan değil.",
