...
export default function RandevuMagazaDeneyimiPage() {
  ...
  const t = loc === "en"
    ? {
        ...
        lead:
          "At 6’ncı Kuyumculuk, our appointment system is designed to make your store visit calmer, more focused, and more efficient. Examine products closely, compare alternatives, and make the right decision with confidence according to your budget.",
        ...
        card1Text:
          "In jewelry, a decision is never made by visuals alone. The fit, craftsmanship, gold setting, intended use, and budget balance must all be evaluated together. The appointment system helps you manage this process without rushing and without distraction.",
        card2Title: "What should you expect during your visit?",
        list1: "Relevant product groups prepared in advance for your needs",
        list2: "Close examination and comparison of jewelry pieces",
    ...
    : {
        ...
        lead:
          "6’ncı Kuyumculuk’ta randevu sistemi, mağaza ziyaretini daha sakin, daha odaklı ve daha verimli hale getirmek için tasarlandı. Ürünleri yakından inceleyin, seçenekleri karşılaştırın ve bütçenize en uygun kararı güvenle verin.",
        ...
        card1Text:
          "Kuyumculukta karar sadece görselliğe bakılarak verilmez. Ürünün duruşu, işçiliği, ayarı, kullanım amacı ve bütçeyle dengesi birlikte değerlendirilir. Randevu sistemi, bu süreci acele etmeden ve dikkat dağılmadan yönetmenizi sağlar.",
