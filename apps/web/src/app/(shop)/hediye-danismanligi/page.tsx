...
export default function HediyeDanismanligiPage() {
  ...
  const t = loc === "en"
    ? {
        ...
        lead:
          "Gift selection should not feel confusing. At 6’ncı Kuyumculuk, our gift consultation approach helps you choose the right jewelry piece according to style, occasion, and budget. Faster process, stronger results.",
    ...
    : {
        ...
        lead:
          "Hediye seçimi karışık değil, net olmalı. 6’ncı Kuyumculuk’ta hediye danışmanlığı yaklaşımı; alıcıya, özel güne ve bütçeye göre en doğru takı alternatifini daha hızlı belirlemenize yardımcı olur.",
