...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: Array<{
    ...
    { path: "/satici", changeFrequency: "weekly", priority: 0.85 },
    { path: "/satici/basvuru", changeFrequency: "weekly", priority: 0.80 },
    { path: "/iletisim", changeFrequency: "monthly", priority: 0.70 },
  ] : [
    { path: "/", changeFrequency: "daily", priority: 1.0 },
    { path: "/shop", changeFrequency: "daily", priority: 0.95 },
    ...
    { path: "/altinci-kuyumculuk", changeFrequency: "monthly", priority: 0.72 },
    // Yasal sayfalar
  ...
  if (CATALOG_RESET_MODE) return sitemap;
