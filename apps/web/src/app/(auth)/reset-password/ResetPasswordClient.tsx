...
export default function ResetPasswordClient() {
  ...
  const isPositiveMessage = Boolean(
    msg &&
      (msg.includes("gönderildi") ||
        msg.includes("başarıyla") ||
        msg.includes("Gelen kutusu"))
  );
    ...
    <main className={styles.wrap}>
      <section className={styles.shell}>
        <aside className={styles.left}>
          ...
          <div className={styles.kicker}>Son adım</div>
          <h1 className={styles.heroTitle}>Yeni başlangıç.</h1>
          ...
          <div className={styles.infoStack}>
            <div className={styles.infoCard}>
              <div className={styles.infoCardTitle}>Hesabını koru</div>
              <div className={styles.infoCardText}>
                Kodunu doğrula ve yalnızca sana özel güçlü bir şifre belirle.
              </div>
            </div>
            <div className={styles.infoMiniGrid}>
              <div className={styles.infoMini}><strong>Şifreli işlem</strong><span>Güvenli akış</span></div>
              <div className={styles.infoMini}><strong>Tek adım</strong><span>Hızlı erişim</span></div>
            </div>
          </div>
        </aside>
        ...
        <section className={styles.right}>
          <div className={styles.card}>
            ...
            {msg ? (
              <div className={`${styles.alert} ${isPositiveMessage ? styles.successAlert : ""}`}>
                {msg}
              </div>
            ) : null}
