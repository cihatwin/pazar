...
function SiteSettingsAdminPageInner() {
  ...
  const [cfg, setCfg] = useState<SiteSettings>(() =>
    normalizeSite({
      ...
      theme: { variant: "auto" },
      brand: {
        title: { tr: "6'ncı Kuyumculuk", en: "Altinci Jewelry" },
        tagline: emptyLT(),
        logoUrl: "",
        faviconUrl: "",
        logoLink: "/",
              ...
              <div className={s.grid2}>
                <div className={s.field}>
                  ...
                  <input
                    ...
                    placeholder="Örn: 6'ncı Kuyumculuk"
                  />
                </div>
                <div className={s.field}>
                  <label className={s.label}>🇬🇧 English</label>
                  <input
                    ...
                    placeholder="E.g.: Altinci Jewelry"
                  />
                </div>
              </div>
            </div>
              ...
              <div className={s.grid2}>
                <div className={s.field}>
                  ...
                  <input
                    ...
                    placeholder="Örn: Altın ve mücevherat"
                  />
                </div>
                <div className={s.field}>
                  <label className={s.label}>🇬🇧 English</label>
              ...
              <div className={s.grid2}>
                <div className={s.field}>
                  ...
                  <input
                    ...
                    placeholder="Cumhuriyet Mah. Belediye Cd. No:9, Fethiye/Muğla"
                  />
                </div>
                <div className={s.field}>
                  <label className={s.label}>🇬🇧 English</label>
              ...
              <div className={s.grid2}>
                <div className={s.field}>
                  ...
                  <input
                    ...
                    placeholder="Örn: 6'ncı Kuyumculuk | Altın & Mücevherat"
                  />
                </div>
                <div className={s.field}>
                  <label className={s.label}>🇬🇧 English</label>
                  <input
                    ...
                    placeholder="E.g.: Altinci Jewelry | Gold & Jewelry"
                  />
                </div>
              </div>
            </div>
