  ...
  useEffect(() => {
    ...
    return onSnapshot(
      ...
      (snap) => {
        ...
        setBrandTitle({
          tr: safeStr(footer.brand?.title?.tr) || "6'ncı Kuyumculuk",
          en: safeStr(footer.brand?.title?.en) || "Altinci Jewelry",
        });
        setBrandTagline({
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
            ...
            <div>
              ...
              <input
                ...
                placeholder="Mücevher uzmanlarımız..."
              />
            </div>
            <div>
              ...
              <input
                ...
                placeholder="Our jewelry experts..."
              />
            </div>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
            ...
            <div style={{ gridColumn: "1 / -1" }}>
              ...
              <input
                ...
                placeholder="Cumhuriyet, Belediye Cd. No:9, 48303 Fethiye/Muğla"
              />
            </div>
            <div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
            <div>
              ...
              <input
                ...
                placeholder="© {{year}} 6'ncı Kuyumculuk — Tüm hakları saklıdır."
              />
            </div>
            <div>
              ...
              <input
                ...
                placeholder="© {{year}} Altinci Jewelry — All rights reserved."
              />
            </div>
            <div>
