...
const DEFAULT_FORM: FormState = {
  card: {
    ...
    provider: "paytr",
    merchantTitle: "6’ncı Kuyumculuk",
  ...
  bankTransfer: {
    isActive: false,
    adminPreviewEnabled: true,
    companyName: "BİZİM 6 KUYUMCULUK İNŞAAT EMLAK SANAYİ TİCARET LİMİTED ŞİRKETİ",
    bankName: "",
    branchName: "",
    accountName: "BİZİM 6 KUYUMCULUK İNŞAAT EMLAK SANAYİ TİCARET LİMİTED ŞİRKETİ",
    accountNumber: "",
    iban: "",
    currency: "TRY",
                ...
                <div className={styles.formGrid}>
                  ...
                  <label className={`${styles.field} ${styles.full}`}>
                    ...
                    <input
                      ...
                      placeholder="BİZİM 6 KUYUMCULUK..."
                    />
                  </label>
