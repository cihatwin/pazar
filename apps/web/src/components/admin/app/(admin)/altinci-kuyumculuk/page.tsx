...
const DEFAULTS = {
  isActive: true,
  hero: {
    eyebrow: "Altıncı Kuyumculuk",
    title: "Altın Değerinde Anlar İçin “Bizim 6’ncı” Sizinle",
    description: "",
  ...
  beliefs: {
    ...
    items: [
      "Zarafeti güçlü bir sunumla buluşturan seçkin mücevher anlayışı",
  ...
  cta: {
    ...
    description:
      "Altıncı Kuyumculuk olarak kapımızdan içeri giren herkesi saygıyla karşılar, memnuniyet odaklı bir yaklaşımı ilke ediniriz.",
    cards: [
      { title: "Konum", text: "Fethiye’nin kalbinde" },
