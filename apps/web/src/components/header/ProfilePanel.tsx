...
import { MapPin, Package, RotateCcw, Truck, UserRound } from "lucide-react";
...
function marketplaceText(v: any) {
  return safeStr(v)
    .replace(/Bizim\s*6['’]?nc[ıi]\s*Kuyumculuk/gi, "PAZAR.")
    .replace(/6['’]?nc[ıi]\s*Kuyumculuk/gi, "PAZAR.");
}
...
},
{
            ...
            <section className={styles.guestHero}>
              ...
              <div className={styles.guestTop}>
                <div className={styles.guestEyebrow}>
                  {loc === "en" ? "PAZAR PRIVATE ACCOUNT" : "PAZAR ÖZEL HESAP"}
                </div>
  ...
  <div className={styles.vipAccountHeader}>
    ...
    <div className={styles.vipAccountSeal}>P.</div>
  </div>
                  ...
                  {inboxItems.map((item) => (
                    ...
                    >
                        <div className={styles.notificationTop}>
                          <strong>
                            {marketplaceText(item.title) || (loc === "en" ? "Notification" : "Bildirim")}
                          </strong>
                        ...
                        <div className={styles.notificationBody}>
                          {marketplaceText(item.body) || (loc === "en" ? "Open details" : "Detayı aç")}
                        </div>
