      ...
      <section className={styles.modal} role="dialog" aria-modal="true" aria-labelledby="appointment-modal-title">
        ...
        {status === "success" ? (
          <div className={styles.success}>
            ...
            <p>{en ? "Our jewellery consultant will contact you to confirm the time." : "Mücevher danışmanımız saat teyidi için sizinle iletişime geçecek."}</p>
          ...
          <div className={styles.layout}>
            <aside className={styles.intro}>
              ...
              <div className={styles.kicker}>{en ? "Private jewellery consultation" : "Özel mücevher danışmanlığı"}</div>
            ...
            <form className={styles.form} onSubmit={submit}>
              ...
              <fieldset><legend>{en ? "Meeting preference" : "Görüşme tercihi"}</legend><div className={styles.typeGrid}>
                <button type="button" className={form.meetingType === "store" ? styles.selected : ""} onClick={() => update("meetingType", "store")}><MapPin /><span><strong>{en ? "In store" : "Mağazada"}</strong><small>Fethiye</small></span></button>
