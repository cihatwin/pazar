      ...
      <div className={styles.sidebarCard}>
        <div className={styles.sidebarTop}>
          <div className={styles.sidebarBrand}>
            <div className={styles.sidebarBrandMark}>P.</div>

            <div className={styles.sidebarBrandText}>
              <div className={styles.sidebarBrandName}>PAZAR.</div>
              <div className={styles.sidebarBrandSub}>Özel hesap deneyimi</div>
            </div>
          </div>

          <div className={styles.sidebarHero}>
            <div className={styles.sidebarKicker}>PAZAR. ACCOUNT</div>
