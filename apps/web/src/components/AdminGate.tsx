...
export default function AdminGate({ children }: { children: React.ReactNode }) {
  ...
  // /admin layout already renders the PAZAR. shell and performs the primary
  // authorization check. Keep this legacy gate as a security boundary for old
  // modules, but do not render a second branded header inside the new shell.
  return <>{children}</>;
}
