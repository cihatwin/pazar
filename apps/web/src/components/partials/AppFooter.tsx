...
const SITE_COLUMNS: FooterColumn[] = [
  ...
  },
  {
    ...
    links: [
      { label: { tr: "Hakkımızda", en: "About" }, url: "/altinci-kuyumculuk" },
...
export default function AppFooter() {
  ...
  const ctaDesc = localeText(
    ...
    "Mücevher uzmanlarımız sana en uygun parçayı bulmak için burada.",
  ...
  const bottomLeft = localeText(
    loc,
    cfg?.bottom?.left,
    "© {{year}} 6'ncı Kuyumculuk — Tüm hakları saklıdır.",
    "© {{year}} Altinci Jewelry — All rights reserved."
