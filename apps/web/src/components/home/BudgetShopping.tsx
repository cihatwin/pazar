...
const DEFAULT_RANGES: BudgetRange[] = [
  ...
  { label: { tr: "50.000 TL Üzeri", en: "Over TRY 50,000" }, note: { tr: "Yüksek mücevher", en: "Fine jewellery" }, minPrice: 50000 },
];
  ...
  return (
    <section className={styles.section} aria-labelledby="budget-shopping-title">
      <div className={styles.frame}>
        <Image
          src="/home/budget-jewelry-editorial-v1.jpg"
          alt={loc === "en" ? "A curated collection of gold jewellery" : "Seçkin altın mücevher koleksiyonu"}
          fill
