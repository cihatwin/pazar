...
function groupLabel(key: string, loc: "tr" | "en" = "tr") {
  ...
  switch (key) {
    ...
    case "jewelry":
      ...
      return loc === "en" ? "Jewelry Selection" : "Takı Seçkisi";
  ...
  return (
    ...
    >
      {current ? (
        ...
        <div className={styles.imageFallback}>6NCI</div>
      )}
...
const [activeSlide, setActiveSlide] = useState(0);
  ...
  const { loc } = useT();
    ...
    () => ({
      ...
      brand: loc === "en" ? "6nci Jewelry" : "6'ncı Kuyumculuk",
      newModels: loc === "en" ? "New Models" : "Yeni Modeller",
      jewelrySelection: loc === "en" ? "Jewelry Selection" : "Takı Seçkisi",
